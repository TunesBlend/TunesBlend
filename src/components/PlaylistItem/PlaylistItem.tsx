    ...
    return (
        <div>
            ...
            <div className="hidden xl:block">
                <div className="mt-4 border p-4 rounded shadow grid grid-cols-5 gap-4 dark:bg-gray-700 dark:border-transparent dark:shadow-gray-700">
                    ...
                    <div className="col-span-1 flex flex-col justify-center gap-3 my-2">
                        <div>
                            <a
                                href={`/playlists/details/${playlist.id}`}
                                className="text-center block bg-green-800 hover:bg-green-900 text-white px-3 py-2 rounded mb-4 transition duration-250 ease-in-out"
                            >
                                Details
                            </a>
                            <a
